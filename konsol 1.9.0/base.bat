...
echo                                                                                          even better UI 
echo                  Welcome back, %username%!  How may I help you today?                   (yet again bruh)
echo               ╔═══════════════════════════════════════════════════╤════════════════════════════════════╗
echo               ║  Programs                                         │  Runs                              ║
echo               ╟───────────────────────────────────────────────────┼────────────────────────────────────╢
...
echo               ║ [4]  Dialer                                       │ dialer.exe                         ║
echo               ║ [5]  ► File Explorer                              │ List of File Explorer types        ║
echo               ║ [6]  ► Management                                 │ List of Management programs        ║
echo               ║ [7]  ► Media Players                              │ dvdplay.exe                        ║
echo               ║ [8]  ► Writing                                    │ Notepads List                      ║
echo               ║ [9]  Paint                                        │ mspaint.exe                        ║
echo               ║ [0]  ► Terminals                                  │ Terminals List                     ║
echo               ╚═══════════════════════════════════════════════════╧════════════════════════════════════╝
echo.
echo                 [X]  Close Konsol       [I]  About Konsol         [S]  Specials                 Today is:
echo                 [R]  Refresh Konsol     [G]  Search in Google     [E]  Extras                 %date%
echo.
echo.
...
if %errorlevel% == 6 (
    ...
    color 07
    timeout /t 1 /nobreak >nul
    echo Opening management programs list...
    timeout /t 3 /nobreak >nul
    cls
    goto management
    goto :start
...
if %errorlevel% == 12 (
    ...
    echo                                \ \/ / ││¯¯ │ 0_/ /  _│ │ │ /   \ │  \ │ │ 0 /_  │   / . \   
    echo                                 \  /  ││-- ││\\  \_  \ │ │ │ O │ │ │\\│ │     │ │   \__ │   
    echo                                  \/   ││__ ││ \\ │___/ │_│ \___/ │_│ \__│ 0   │_│ 0 │___/  
    echo.
