...
echo                               I      \  I  \/  I I         I _\    \  I  \/  I I   L___      v1.7
echo                               L__I\___\ \______/ L___I\____I L_____/  \______/ L______7  Now comes with
echo                                         Copyright free but please don't copy :(          even better UI              
echo              ============================================================================================
...
echo               I [D]  Terminals                                    I Terminals List                     I
echo              -I---------------------------------------------------I------------------------------------I-       
echo                 [x]  Close Konsol       [i] About Konsol                                       Today is:
echo                 [r]  Restart Konsol                                                          %date%
...
if %errorlevel% == 16 (
    ...
    timeout /t 1 /nobreak >nul
    echo.
    powershell write-host ".--------------------------------L__1\___\ \______/ L___I\____I L_____/  \______/ L______7------------------------------." -ForegroundColor White -BackgroundColor White
    echo.
    timeout /t 1 /nobreak >nul
    echo                                __  __ ____ _____  ____ ___  ___  ___  ___    ____    _____
    echo                                \V\/V/ II   I 0_I /  _I I I /   \ I I\ I I 0 /_  I   I_   /
    echo                                 \VV/  II-- II\\  \_  \ I I I O I I I\\I I     I I    /  /
    echo                                  \/   II__ II \\ I___/ I_I \___/ I_I \I_I 0   I_I 0 /__/
    timeout /t 1 /nobreak >nul
    echo.
    echo.
...
color 0b
timeout /t 1 /nobreak >nul
powershell write-host ".--------------------------------L__1\___\ \______/ L___I\____I L_____/  \______/ L______7------------------------------." -ForegroundColor Cyan -BackgroundColor Cyan
powershell write-host ".--------------------------------L__1\___\ \______/ L___I\____I L_____/  \______/ L______7------------------------------." -ForegroundColor Cyan -BackgroundColor Cyan
powershell write-host ".--------------------------------L__1\___\ \______/ L___I\____I L_____/  \______/ L______7------------------------------." -ForegroundColor Cyan -BackgroundColor Cyan
powershell write-host ".--------------------------------L__1\___\ \______/ L___I\____I L_____/  \______/ L______7------------------------------." -ForegroundColor Cyan -BackgroundColor Cyan
powershell write-host ".--------------------------------L__1\___\ \______/ L___I\____I L_____/  \______/ L______7------------------------------." -ForegroundColor Cyan -BackgroundColor Cyan
